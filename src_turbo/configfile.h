...
typedef enum {
	...
	processor_clk_multiplier2_token,
	robsize_token,
	max_retire_token,
	max_fetch_token,
	pipelinedepth_token,
	...
	wq_capacity2_token,
	address_mapping2_token,
	wq_lookup_latency2_token,
...
token_t tokenize(char * input){
  ...
  } else if (strncmp(input, "PROCESSOR_CLK_MULTIPLIER2",length) == 0) {
	return processor_clk_multiplier2_token;
  ...
  } else if (strncmp(input, "NUM_CHANNELS2",length) == 0) {
	return num_channels2_token;
  } else if (strncmp(input, "NUM_RANKS2",length) == 0) { 
	return num_ranks2_token;
  } else if (strncmp(input, "NUM_BANKS2",length) == 0) {
	return num_banks2_token;
  } else if (strncmp(input, "NUM_ROWS2",length) == 0) {
	return num_rows2_token;
  } else if (strncmp(input, "NUM_COLUMNS2",length) == 0) {
	return num_columns2_token;
  } else if (strncmp(input, "CACHE_LINE_SIZE2",length) == 0) {
	return cache_line_size2_token;
  } else if (strncmp(input, "ADDRESS_BITS2",length) == 0) {
	return address_bits2_token;
 ...
 } else if (strncmp(input, "DRAM_CLK_FREQUENCY2",length) == 0) {
	return dram_clk_frequency2_token;
  } else if (strncmp(input, "T_RC2",length) == 0) {
	return t_rc2_token;
  } else if (strncmp(input, "T_RP2",length) == 0) {
    return t_rp2_token;
  } else if (strncmp(input, "T_CAS2",length) == 0) {
    return t_cas2_token;
  } else if (strncmp(input, "T_RCD2",length) == 0) {
    return t_rcd2_token;
  } else if (strncmp(input, "T_RAS2",length) == 0) {
    return t_ras2_token;
  } else if (strncmp(input, "T_RRD2",length) == 0) {
    return t_rrd2_token;
  } else if (strncmp(input, "T_FAW2",length) == 0) {
    return t_faw2_token;
  } else if (strncmp(input, "T_WR2",length) == 0) {
	return t_wr2_token;
  } else if (strncmp(input, "T_WTR2",length) == 0) {
	return t_wtr2_token;
  } else if (strncmp(input, "T_RTP2",length) == 0) {
	return t_rtp2_token;
  } else if (strncmp(input, "T_CCD2",length) == 0) {
    return t_ccd2_token;
  } else if (strncmp(input, "T_RFC2",length) == 0) {
	return t_rfc2_token;
  } else if (strncmp(input, "T_REFI2",length) == 0) {
	return t_refi2_token;
  } else if (strncmp(input, "T_CWD2",length) == 0) {
	return t_cwd2_token;
  } else if (strncmp(input, "T_RTRS2",length) == 0) {
	return t_rtrs2_token;
  } else if (strncmp(input, "T_PD_MIN2",length) == 0) {
	return t_pd_min2_token;
  } else if (strncmp(input, "T_XP2",length) == 0) {
	return t_xp2_token;
  } else if (strncmp(input, "T_XP_DLL2",length) == 0) {
	return t_xp_dll2_token;
  } else if (strncmp(input, "T_DATA_TRANS2",length) == 0) {
	return t_data_trans2_token;	
  ...
  } else if (strncmp(input, "WQ_CAPACITY2",length) == 0) {
	return wq_capacity2_token;
  } else if (strncmp(input, "ADDRESS_MAPPING2",length) == 0) {
	return address_mapping2_token;
  } else if (strncmp(input, "WQ_LOOKUP_LATENCY2",length) == 0) {
	return wq_lookup_latency2_token;
  }
...
void read_config_file(FILE * fin)
{
	...
	while ((c = fgetc(fin)) != EOF){
		...
		switch(input_field)
		{
			...
			case processor_clk_multiplier2_token:
				fscanf(fin,"%d",&input_int);
				PROCESSOR_CLK_MULTIPLIER2 =  input_int;
				break;
...
//--------------------------------------------------------------------------------------------------------------------------------------------
			...
			case num_channels2_token:
				fscanf(fin,"%d",&input_int);
				NUM_CHANNELS2 =  input_int;
				break;


			case num_ranks2_token:
				fscanf(fin,"%d",&input_int);
				NUM_RANKS2 =  input_int;
				break;

			case num_banks2_token:
				fscanf(fin,"%d",&input_int);
				NUM_BANKS2 =  input_int;
				break;

			case num_rows2_token:
				fscanf(fin,"%d",&input_int);
				NUM_ROWS2 =  input_int;
				break;

			case num_columns2_token:
				fscanf(fin,"%d",&input_int);
				NUM_COLUMNS2 =  input_int;
				break;

			case cache_line_size2_token:
				fscanf(fin,"%d",&input_int);
				CACHE_LINE_SIZE2 =  input_int;
				break;

			case address_bits2_token:
				fscanf(fin,"%d",&input_int);
				ADDRESS_BITS2 =  input_int;
				break;

			case dram_clk_frequency2_token:
				fscanf(fin,"%d",&input_int);
				DRAM_CLK_FREQUENCY2 =  input_int;
				break;

			case t_rcd2_token:
				fscanf(fin,"%d",&input_int);
				T_RCD2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_rp2_token:
				fscanf(fin,"%d",&input_int);
				T_RP2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_cas2_token:
				fscanf(fin,"%d",&input_int);
				T_CAS2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_rc2_token:
				fscanf(fin,"%d",&input_int);
				T_RC2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_ras2_token:
				fscanf(fin,"%d",&input_int);
				T_RAS2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_rrd2_token:
				fscanf(fin,"%d",&input_int);
				T_RRD2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_faw2_token:
				fscanf(fin,"%d",&input_int);
				T_FAW2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_wr2_token:
				fscanf(fin,"%d",&input_int);
				T_WR2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_wtr2_token:
				fscanf(fin,"%d",&input_int);
				T_WTR2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_rtp2_token:
				fscanf(fin,"%d",&input_int);
				T_RTP2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_ccd2_token:
				fscanf(fin,"%d",&input_int);
				T_CCD2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_rfc2_token:
				fscanf(fin,"%d",&input_int);
				T_RFC2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_refi2_token:
				fscanf(fin,"%d",&input_int);
				T_REFI2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_cwd2_token:
				fscanf(fin,"%d",&input_int);
				T_CWD2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_rtrs2_token:
				fscanf(fin,"%d",&input_int);
				T_RTRS2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_pd_min2_token:
				fscanf(fin,"%d",&input_int);
				T_PD_MIN2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_xp2_token:
				fscanf(fin,"%d",&input_int);
				T_XP2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_xp_dll2_token:
				fscanf(fin,"%d",&input_int);
				T_XP_DLL2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;

			case t_data_trans2_token:
				fscanf(fin,"%d",&input_int);
				T_DATA_TRANS2 = input_int*PROCESSOR_CLK_MULTIPLIER2;
				break;
			...
			case wq_capacity2_token:
				fscanf(fin,"%d",&input_int);
				WQ_CAPACITY2 = input_int;
				break;

			case address_mapping2_token:
				fscanf(fin,"%d",&input_int);
				ADDRESS_MAPPING2= input_int;
				break;
			
			case wq_lookup_latency2_token:
				fscanf(fin,"%d",&input_int);
				WQ_LOOKUP_LATENCY2 = input_int;
				break;
...
void print_params()
{
	...
	printf("PROCESSOR_CLK_MULTIPLIER2:   %6d\n", PROCESSOR_CLK_MULTIPLIER2);
	printf("ROBSIZE:                    %6d\n", ROBSIZE);
	printf("MAX_FETCH:                  %6d\n", MAX_FETCH);
  ...
  printf("\n---------------\n");
	printf("- DRAM Cache Config -\n");
	printf("---------------\n");
	printf("NUM_CHANNELS2:               %6d\n", NUM_CHANNELS2);
  printf("NUM_RANKS2:                  %6d\n", NUM_RANKS2);
  printf("NUM_BANKS2:                  %6d\n", NUM_BANKS2);
  printf("NUM_ROWS2:                   %6d\n", NUM_ROWS2);
  printf("NUM_COLUMNS2:                %6d\n", NUM_COLUMNS2);

	printf("\n---------------\n");
	printf("- DRAM Cache Timing -\n");
	printf("---------------\n");
	printf("T_RCD2:                      %6d\n", T_RCD2);
  printf("T_RP2:                       %6d\n", T_RP2);
  printf("T_CAS2:                      %6d\n", T_CAS2);
  ...
  printf("WQ_LOOKUP_LATENCY:          %6d\n", WQ_LOOKUP_LATENCY);
  	...
  	printf("\n-------------------\n");
	printf("- DRAM Cache Controller -\n");
	printf("-------------------\n");
	printf("WQ_CAPACITY2:                %6d\n", WQ_CAPACITY2);
  printf("ADDRESS_MAPPING2:            %6d\n", ADDRESS_MAPPING2);
  printf("WQ_LOOKUP_LATENCY2:          %6d\n", WQ_LOOKUP_LATENCY2);
	printf("\n----------------------------------------------------------------------------------------\n");
